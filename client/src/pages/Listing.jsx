...
function Listing() {
    ...
    return (
        <main>
            ...
            {
                error && <p className=' text-center my-7 text-xl text-rose-700'>Something went wrong</p>
            }
            {
                listing && !loading && !error && (
                    <>
                        ...
                        <div className=' fixed top-[13%] right-[3%] border z-10 rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer'>
                            <FaShare
